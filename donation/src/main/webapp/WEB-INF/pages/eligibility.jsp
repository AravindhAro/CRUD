...
<html lang="en">
    <head>
        <title>Eligibility | Blood Donors India</title>
        <meta charset="utf-8">
    ...
    border-left:1px solid ;
     border-top:1px solid ;"">
        ...
        <div style="border-radius: 50%;background-color: yellow; height: 150px;width: 150px;margin-left: auto;margin-right: auto;">
            <div class="count-up h1 text-center"  style="padding-top: 25px;font-size:2rem;color:#6A1208;margin-top:30px;">BLOOD DONORS</div>
            <div style="color:#6A1208;"></div>
        </div>
    </div>
</div>        <div class="container">
            <div class="col-md-12">
                <div class="center"><h3>Blood Donors Eligibility</h3></div>
